                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <div class="col-xs-3">
                                Sexo
                            <div class="dropdown">
                                <button runat="server" id="cmbAlumno" class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">
                        ...
                        <div class="form-group">
                             <div class="col-xs-5">
                                Matricula
                            <asp:TextBox  id="txtMatriculaAgregar" class="form-control" required="" type="text" runat="server"></asp:TextBox>
                        </div>
                             </div>
